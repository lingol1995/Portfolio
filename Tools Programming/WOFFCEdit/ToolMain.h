...
public: //methods
	...
	void	moveSelected(float X, float Y, float Z, float rotX,float rotY, float rotZ);
	void	scaleSelected(float X, float Y, float Z);
	void	changeTexture(std::string name, std::string texture, std::string mesh);
